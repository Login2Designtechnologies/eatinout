...
class Strings {
  static  String appName = 'Payment Card Demo'.tr;
  static  String fieldReq = 'This field is required'.tr;
  static  String numberIsInvalid = 'Card is invalid'.tr;
  static  String pay = 'Validate'.tr;
}
...
class CardUtils {
  ...
  static Widget? getCardIcon(CardTypee? cardType) {
    ...
    Widget? widget;
    if (img.isNotEmpty) {
      widget = Image.asset('assets/$img', width: 12);
    } else {
      widget = icon;
    }
    return widget;
