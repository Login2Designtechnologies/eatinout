...
class PaystackController extends GetxController implements GetxService {
  ...
  Future getPaystack({required String amount}) async {
    ...
    var response = await http.post(Uri.parse("https://dineout.zozostudio.tech/paystack/index.php"),
  ...
  Future checkPaystack({required String sKey}) async {
    ...
    var response= await http.post(Uri.parse("https://dineout.zozostudio.tech/paystack/callback.php",),
