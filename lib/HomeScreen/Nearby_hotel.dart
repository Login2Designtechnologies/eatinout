        ...
        child: Padding(
            ...
            child: GetBuilder<NearybyController>(builder: (context) {
              return nearbyrest.isLoading
                  ? nearbyrest.nearByRestaurantList.isNotEmpty
                      ? Column(
                          children: [
                            ListView.builder(
                              ...
                              itemCount: nearbyrest.nearByRestaurantList.length,
                              itemBuilder: (BuildContext context, int index) {
                                return RestaurantCard(
                                    data:
                                        nearbyrest.nearByRestaurantList[index]);
                                // return InkWell(
                                //   onTap: () {
                                //     // selectedbox = true;
                                //     Get.to(() => HotelDetails(
                                ...
                                //           children: [
                                //             Text(
                                //               nearbyrest.cuisinerestlist[index]
                                //                   ["title"],
                                //               style: TextStyle(
                                //                   fontSize: 15,
                                //                   fontFamily: "Gilroy Bold",
