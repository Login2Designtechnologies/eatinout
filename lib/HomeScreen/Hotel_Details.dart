...
class _HotelDetailsState extends State<HotelDetails>
  ...
  checkIfResHasOffers() {
    ...
    for (var i = 0; i < homeController.offersList.length; i++) {
      ...
      if (homeController.offersList[i].restaurant.toString() ==
  ...
  checkIfResHasDeals() {
    for (var i = 0; i < homeController.dealList.length; i++) {
      if (homeController.dealList[i].restaurant.toString() ==
          widget.detailId.toString()) {
                          ...
                          ? Stack(
                              children: [
                                GetBuilder<HoteldetailController>(
                                    builder: (context) {
                                  String time =
                                      hoteldata.hoteldetails["open_time"];
                                  String closetime =
                                      hoteldata.hoteldetails["close_time"];
                                  List<String> durations = time.split(':');
                                  List<String> close = closetime.split(':');
                                  print(
                                      '${durations[0]} hours ${durations[1]} minutes ');
                                ...
                                Positioned(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      Get.to(() =>
                                          Gallery(galleryid: widget.detailId));
                                    },
                                    child: ClipRRect(
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    GetBuilder<HoteldetailController>(
                                        builder: (context) {
                                      String str = hoteldata
                                          .hoteldetails["popular_dish"];
                                      strarray = str.split(",");
                                      return GridView(
                                          shrinkWrap: true,
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    decoration:
                                                                        BoxDecoration(
                                                                            border:
                                                                                Border.all(color: notifier.textColor)),
                                                                    child:
                                                                        Column(
                                                                      mainAxisAlignment:
                                                                          MainAxisAlignment
                                                                              .center,
                                                                      children: [
                                                                        GetBuilder<HoteldetailController>(builder:
                                                                            (context) {
                                                                          String
                                                                              currentdiscount =
                                                                              "";
                                                                          ...
                                                                          return Text(
                                                                              "${currentdiscount}% OFF",
                                                                              style: TextStyle(fontFamily: "Gilroy Bold", color: notifier.background, fontSize: 20));
                                                                        }),
                                                                        SizedBox(
                                                                            height:
                                                                                Get.height * 0.01),
