...
class DealsPage extends StatefulWidget {
  ...
  const DealsPage({super.key, this.pageTitle = "Deals"});
        ...
        child: Padding(
            ...
            child: GetBuilder<HomeController>(builder: (context) {
              return homeController.isLoading
                  ? homeController.dealList.isNotEmpty
                      ? Column(
                          children: [
                            ListView.builder(
                              ...
                              itemCount: homeController.dealList.length,
                              itemBuilder: (BuildContext context, int index) {
                                return InkWell(
                                  onTap: () {
                                    Get.to(() => HotelDetails(
                                        detailId: homeController
                                            .dealList[index].restaurant));
                                  },
                                  child: Container(
                                    margin:
                                      ...
                                      children: [
                                            ...
                                            child: Stack(children: [
                                              FadeInImage.assetNetwork(
                                                ...
                                                image: AppUrl.imageurl +
                                                    "${homeController.dealList[index].bannerImage}",
                                                fit: BoxFit.cover,
                                              ),
                                            ]),
                                          ),
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            // Text(
                                            //   "homeController.dealList[index] .dealTitle" ??
                                            //       '',
                                                    ...
                                                    children: [
                                                      SizedBox(
                                                          width:
                                                              Get.width * 0.32,
                                                          child: Text(
                                                            "EXTRA ${homeController.dealList[index].discount}% OFF",
                                                            style: TextStyle(
                                                                fontFamily:
                                                                    "Gilroy Bold",
                                                                color:
