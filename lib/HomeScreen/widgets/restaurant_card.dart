...
class RestaurantCard extends StatefulWidget {
  ...
  RestaurantCard({Key? key, required this.data}) : super(key: key);
...
class _RestaurantCardState extends State<RestaurantCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        // selectedbox = true;
        Get.to(() => HotelDetails(detailId: widget.data.id));
      },
      child: Container(
              ...
              child: ClipRRect(
                ...
                child: Stack(children: [
                  FadeInImage.assetNetwork(
                    ...
                    image: AppUrl.imageurl + widget.data.img.toString(),
                    fit: BoxFit.cover,
                  ),
                ]),
              ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //               print(
                  //                   'current discount aieu oiuwerweroiu>>>>>${widget.data.frisun}');
                  //               print(
                  //                   'current discount aieu oiuwerweroiu>>>>>${widget.data.monthru}');
                  ...
                  //                 print('current discount>>>>>$currentdiscount');
                  //               }
                  //               return Text(
