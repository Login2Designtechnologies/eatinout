...
import 'package:dineout/Payment/Payment_Discount.dart';
import 'package:dineout/Payment/Payment_Successfull.dart';
...
class Tab2 extends StatefulWidget {
  ...
  String? address;
  String? tip;
  Tab2({this.restid, this.hotelname, this.address, this.tip, super.key});
...
class _Tab2State extends State<Tab2> {
  ...
  // print(times);
  // final opentime = TimeOfDay(hour: 1, minute: 0);
  // final closetime = TimeOfDay(hour: 24, minute: 0);
