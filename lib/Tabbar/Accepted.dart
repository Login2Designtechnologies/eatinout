...
import 'package:dineout/Getx_Controller/Table_status_wise_controller.dart';
import 'package:dineout/Profile/Table_booking_details.dart';
...
class Accepted extends StatefulWidget {
  String? noofpeople;
  String? bookingdate;
  Accepted({this.noofpeople, this.bookingdate, super.key});
...
class _AcceptedState extends State<Accepted> {
  ...
  void initState() {
    super.initState();
    getDarkMode();
    bookingstatus.tableStatus(status: "Accepted");
  }
                  ...
                  bookingstatus.isLoading
                      ? bookingstatus.tableStatusList.isNotEmpty
                          ...
                          : Padding(
                              ...
                              child: Center(
                                child: Text(
                                  "You have no upcoming bookings.".tr,
