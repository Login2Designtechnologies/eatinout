    ...
    title: Column(
      ...
      children: [
        Text(
          Hedingtext!,
          style:
              TextStyle(fontFamily: "Gilroy Bold", color: color, fontSize: 16),
        ),
        Text(subtext,
            style: TextStyle(
      ...
      child: Padding(
        ...
        child: InkWell(
            onTap: callback == null
                ...
                : callback,
            child:
                Image.asset("assets/arrowleft.png", height: 20, color: color)),
      ),
    ),
    centerTitle: true,
    title: Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(centertext,
              style: TextStyle(
                  color: color, fontFamily: "Gilroy ExtraBold", fontSize: 20)),
        ),
        Text(subtitletext,
            style: TextStyle(
              color: greycolor,
            ...
            child: Container(
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: <Color>[orangeColor, orangeColor, orangeColor],
                  ),
